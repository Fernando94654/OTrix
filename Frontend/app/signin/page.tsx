...
import { saveName, saveRole, saveToken, signUp } from '@/lib/auth';
...
export default function SignupPage() {
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (!isPasswordStrong(password)) {
      const message = 'Your password does not meet all security requirements.';
      ...
      <div className='auth__inner'>
        <section className='auth__panel auth__panel--wide'>
          <header className='auth__header'>
            ...
            <p className='auth__sub'>Set up your OTrix profile to start running scenarios in minutes.</p>
          </header>

          <form className='auth__form auth__form--grid' onSubmit={onSubmit} noValidate>
            <div className='auth-field'>
              <label htmlFor='idName' className='auth-field__label'>First name</label>
              <input
                id='idName'
                type='text'
            ...
            <div className='auth-field'>
              <label htmlFor='idLastName' className='auth-field__label'>Last name</label>
              <input
                id='idLastName'
                type='text'
                className='auth-field__input'
            ...
            <div className='auth-field'>
              <label htmlFor='idGender' className='auth-field__label'>Gender</label>
              <select
                id='idGender'
            ...
            <div className='auth-field'>
              <label htmlFor='idDateOfBirth' className='auth-field__label'>Date of birth</label>
              <input
                id='idDateOfBirth'
                type='date'
                className='auth-field__input'
            ...
            <div className='auth-field auth-field--full'>
              ...
              <input
                ...
                type='email'
                className='auth-field__input'
                placeholder='johndoe@rockwell.com'
                autoComplete='email'
                value={email}
            ...
            <div className='auth-field auth-field--full'>
              <label htmlFor='idCompany' className='auth-field__label'>
                Company <span className='auth-field__optional'>· optional</span>
              </label>
              <input
                id='idCompany'
                type='text'
            ...
            <div className='auth-field auth-field--password'>
              <label htmlFor='idConfirmPassword' className='auth-field__label'>Confirm password</label>
              <input
            ...
            {errorMessage ? (
              <div className='auth__error auth-field--full' role='alert'>{errorMessage}</div>
            ) : null}

            <button
              className='home-btn home-btn--primary home-btn--large auth__submit auth-field--full'
              type='submit'
